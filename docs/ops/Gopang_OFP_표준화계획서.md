...
GET /.well-known/webfinger
  ?resource=acct:kim_cheolsu@hondi.net
  &rel=http://ofp.hondi.net/ns/user
...
```json
{
  "subject": "acct:kim_cheolsu@hondi.net",
  "aliases": [
    "https://hondi.net/users/kim_cheolsu"
  ],
  "links": [
    {
      "rel": "http://ofp.hondi.net/ns/user",
      "type": "application/ofp+json",
      "href": "https://hondi.net/ofp/users/kim_cheolsu"
    },
    {
      "rel": "http://ofp.hondi.net/ns/inbox",
      "href": "https://hondi.net/ofp/inbox/kim_cheolsu"
    }
  ]
}
```
...
{
  "ofp_version": "1.0",
  "id": "https://hondi.net/ofp/users/kim_cheolsu",
  "type": "OFPUser",
  ...
  "public_key": {
    "id": "https://hondi.net/ofp/users/kim_cheolsu#key",
    "type": "Ed25519PublicKey",
    "value": "MCowBQYDK2VdA..."
  },
  
  "inbox": "https://hondi.net/ofp/inbox/kim_cheolsu",
  "outbox": "https://hondi.net/ofp/outbox/kim_cheolsu",
...
```
[고팡 사용자 A] → hondi.net → OFP-MSG → nova-ai.kr → [플랫폼 B 사용자 B]

1. A가 "@park_yeonghui@nova-ai.kr" 에게 메시지 작성
2. hondi.net이 nova-ai.kr의 WebFinger로 B의 inbox URL 조회
...
```json
{
  "ofp_version": "1.0",
  "type": "Create",
  "id": "https://hondi.net/ofp/activities/abc123",
  
  "actor": "https://hondi.net/ofp/users/kim_cheolsu",
  "to": ["https://nova-ai.kr/ofp/users/park_yeonghui"],
  
  "object": {
    "type": "OFPMessage",
    "id": "https://hondi.net/ofp/messages/msg789",
    "content": "안녕하세요! 반갑습니다.",
  ...
  "signature": {
    ...
    "creator": "https://hondi.net/ofp/users/kim_cheolsu#key",
...
Signature: keyId="https://hondi.net/ofp/users/kim_cheolsu#key",
           algorithm="ed25519",
...
```
[플랫폼 B 사용자] → OFP-BRIDGE → hondi.net → K-Law AI → 결과 반환
  ...
  "services": [
    {
      ...
      "endpoint": "https://hondi.net/ofp/bridge/k-law",
      "auth_required": false,
    ...
    },
    {
      ...
      "endpoint": "https://hondi.net/ofp/bridge/k-health",
      "auth_required": true,
    ...
    },
    {
      "id": "k-119",
      "name": "K-119 응급 신고",
      "endpoint": "https://hondi.net/ofp/bridge/k-119",
      "auth_required": false,
...
2. hondi.net이 OFP-PAY 메시지를 nova-ai.kr로 전송
3. nova-ai.kr이 B에게 수락 여부 확인
4. B 수락 → hondi.net GDC 원장에서 A 차감 → B 플랫폼 GDC 잔고 증가
5. 양측 PDV에 6하원칙 기록
```
...
```json
{
  ...
  "id": "https://hondi.net/ofp/payments/pay001",
  "actor": "https://hondi.net/ofp/users/kim_cheolsu",
  "to": ["https://nova-ai.kr/ofp/users/park_yeonghui"],
  ...
  "object": {
    ...
    "sender_ledger": "https://gdc.hondi.net/ledger",
...
```json
{
  ...
  "proof": {
    ...
    "verificationMethod": "https://hondi.net/ofp/id#key",
...
{
  "type": "OFPProposal",
  "id": "https://democracy.hondi.net/ofp/proposals/prop042",
...
Step 1 — 신청 (자가 등록)
  ...
  └─ `ofp-registry.hondi.net`에 플랫폼 등록
...
// 사용자 탐색
const user = await client.discover('@kim_cheolsu@hondi.net');
console.log(user.display_name); // "김철수"

// 메시지 전송
await client.sendMessage({
  to: '@kim_cheolsu@hondi.net',
  content: '안녕하세요!',
  encrypted: true
});
